...
- **[docs/problems/](docs/problems/)** — Deep dives into each major problem domain, each evolving independently:
  ...
  - [Agent Execution Environment](docs/problems/agent-execution-environment.md) — Container image design, OpenShell sandbox configuration, resource limits, and cross-platform execution on GitHub Actions and GitLab CI
