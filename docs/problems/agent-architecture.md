...
- How to detect potential side-channel communication? (there could be used a lot of signals to do that - order of de/labelling, comment timing, word/format choices, etc.)
